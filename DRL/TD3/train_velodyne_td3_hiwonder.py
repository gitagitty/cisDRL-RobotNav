...
from velodyne_env_hiwonder import GazeboEnv
...
env = GazeboEnv("multi_robot_scenario_hiwonder.launch", environment_dim)
time.sleep(5)
...
while timestep < max_timesteps:
    ...
    a_in = [(action[0] + 1) / 2, action[1]]
    # while env.last_odom is None or not rospy.is_shutdown():
    #     time.sleep(1)
